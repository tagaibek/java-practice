...
public class Drones {
    private static int findUniqueDeliveryId(int[] deliveryIds) {
    ...
    public void uniqueIdComesFirstTest() {
        ...
        final int actual = findUniqueDeliveryId(new int[]{3, 2, 2, 1, 1});
        assertEquals(expected, actual);
    }
    ...
    public void uniqueIdComesLastTest() {
        ...
        final int actual = findUniqueDeliveryId(new int[]{1, 2, 1, 2, 5});
        assertEquals(expected, actual);
    }
